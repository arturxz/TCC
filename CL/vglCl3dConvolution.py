...
class vgl:
	...
	def execute(self, outputpath):
		...
		self.pgr.vglCl3dConvolution(self.queue, self.img_in_cl.shape, None, self.img_in_cl, self.img_out_cl,
									self.arr_window_cl, np.uint32(self.window_x), np.uint32(self.window_y), np.uint32(self.window_z))
